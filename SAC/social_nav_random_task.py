...
class SocialNavTask(PointNavRandomTask):
    """
    ...
    def __init__(self, env):
        super(SocialNavTask, self).__init__(env)
    ...
    def sample_initial_pos(self, env, ped_id):
        ...
        The initial position is sampled randomly until the position is
    ...
    def reset_agent(self, env):
        ...
        :param env: environment instance
        """
        super(SocialNavTask, self).reset_agent(env)
        if self.offline_eval:
    ...
    def step(self, env):
        ...
        :param env: environment instance
        """
        super(SocialNavTask, self).step(env)
    ...
    def get_termination(self, env, collision_links=[], action=None, info={}):
        ...
        """
        done, info = super(SocialNavTask, self).get_termination(
