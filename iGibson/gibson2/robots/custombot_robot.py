...
class Custombot(LocomotorRobot):
    """
    Locobot robot
    ...
    def __init__(self, config):
        ...
        self.linear_velocity_high = config.get('linear_velocity_high', 0.5)
        self.linear_velocity_low = config.get('linear_velocity_low', -0.3)
    ...
    def set_up_continuous_action_space(self):
        ...
        self.action_high[0] = self.linear_velocity_high
        self.action_high[1] = self.angular_velocity
        self.action_low = -self.action_high
        self.action_low[0] = self.linear_velocity_low
    ...
    def set_up_discrete_action_space(self):
        ...
        """
        assert False, "Custombot does not support discrete actions"

    def get_end_effector_position(self):
        """
        Get end-effector position
        """
        assert False, "Custombot does not have an end-effector"
